...
int main()
{
    ...
    //Initial pose: j0=0.0, j1=pi/6.0 correspond to x = 0.2, y = -0.7464

    JntArray jointInitialPose(chain.getNrOfJoints());
    jointInitialPose(0) = 2*M_PI/3.0;
    jointInitialPose(1) = M_PI/4.0;
    //Final pose: j0=2*pi/3.0, j1=pi/4.0 correspond to x = 0.44992, y = 0.58636
